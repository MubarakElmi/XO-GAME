...
board = pygame.image.load('imgs/board.jpeg')
x_img = pygame.image.load('imgs/X.jpeg')
o_img = pygame.image.load('imgs/O.jpeg')
...
def redrawGameWindow():
    ...
    if gameOver:
        gameOverText = font.render(winner, 1, (255, 255, 255))
